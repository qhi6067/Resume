...
export const CONTACT = {
  ...
  export const EXPERIENCE = [
    {
      ...
      bullets: [
        ...
        "Provide end-to-end system, network, and security engineering solutions for hospitals across the Midwestern region and Latin America.",
        ...
        "Utilize expertise in radio frequency, networking, systems, and ultrasound engineering to design scalable healthcare solutions.",
  ...
  export const SKILLS = {
    programming: [
      ...
      medical: [
        "Foundational medical device and clinical knowledge (9 years)",
        "Pharmacology and disease-state acumen",
        "Medical terminology"
      ],
      ...
      sales: [
        "Technical sales",
        "Cross-functional coordination with IT, Clinical, and Security teams",
        "Solution selling",
        "Bilingual customer relationship building",
        "Objection handling"
      ]
